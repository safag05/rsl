...
# ---- TWILIO CONFIG ----
# Pulling from GitHub Secrets for privacy
account_sid = os.getenv('TWILIO_ACCOUNT_SID')
auth_token = os.getenv('TWILIO_AUTH_TOKEN')
# This is usually "whatsapp:+14155238886" (the Sandbox number)
from_whatsapp = os.getenv('TWILIO_FROM_NUMBER') 

# List of numbers like "15551234567, 15550001111"
